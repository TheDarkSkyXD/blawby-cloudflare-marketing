...
![Settings → Payouts and Billing showing Stripe connected and ready with Charges and Payouts both enabled. Full video walkthrough coming soon.|1280x720](/media/docs/payments/stripe-connect.png)
...
![Payouts and Billing settings showing Stripe connected and ready, with Charges and Payouts both enabled.|1280x720](/media/docs/payments/stripe-checkpoints.png)
...
![Invoice edit view with line items on the left and a live PDF preview on the right, showing total due and bill-to details.|1280x720](/media/docs/payments/first-invoice.png)
