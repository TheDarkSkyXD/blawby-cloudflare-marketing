...
![Practice dashboard after onboarding showing the Get-started progress card, Cashflow summary, recent intakes, and quick-action buttons.|1280x720](/media/docs/onboarding/dashboard-after-setup.png)
