...
![The matter detail panel with the seven tabs across the top, a Next step suggestion, and the matter summary in the right rail. Full video walkthrough coming soon.|1280x720](/media/docs/matters/walkthrough.png)
...
![Matter detail page with the seven tabs annotated ①–⑦: Overview, Work, Notes, Billing, Files, Activity, Settings.|1280x720](/media/docs/matters/tabs-annotated.png)
