...
![An active conversation thread with the client's intake context on the left, message exchange in the middle, and the linked-matter side panel on the right. Full video walkthrough coming soon.|1280x720](/media/docs/chat/conversation-walkthrough.png)
...
![The conversation thread where paralegal analysis surfaces alongside the client's messages and the linked matter.|1280x720](/media/docs/chat/paralegal-analysis-stream.png)
